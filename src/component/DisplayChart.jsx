                    ...
                    <div className="text-center text-white">                
                        <div className="row row-cols-2">
                            <div className="col-md-6">
                                <Link to='/LuckyGame/StartGame/5/Lucky Game' className="nav-link">
                                    {chartDataA}
                                    <p>{luckyText5}</p>
                                </Link>
                            </div>
                            <div className="col-md-6">
                                <Link to='/LuckyGame/StartGame/10/Lucky Game' className="nav-link">
                                    {chartDataB}
                                    <p>{luckyText10}</p>
                                </Link>
                            </div>
                        ...
                        <div className="row row-cols-2">
                            <div className="col-md-6">
                                <Link to='/LuckyGame/StartGame/12/Lucky Game' className="nav-link">
                                    {chartDataC}
                                    <p>{luckyText12}</p>
                                </Link>
                            </div>
                            <div className="col-md-6">
                                <Link to='/LuckyGame/StartGame/15/Lucky Game' className="nav-link">
                                    {chartDataD}
                                    <p>{luckyText15}</p>
                                </Link>
                            </div>
